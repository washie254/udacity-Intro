...
###
    ...
    # inserting a space in between each headline. If necessary, truncate the 
    ...
    # seems most appropriate. Consider adding print statements to your code to help you resolve bugs.
###
...
#     print("current Lenght: {}".format(len(news_ticker)))
#     if len(news_ticker) >= 140:
#         print("  breaking from the loop now!")
#         break
#     elif len(headline) + len(news_ticker) >= 140:
#         print("  skipping {} ".format(headline))
#         continue
#     else:
#         print("  adding {} ({})".format(headline, len(headline)))
#         #news_ticker.append(str(" "+headline))
